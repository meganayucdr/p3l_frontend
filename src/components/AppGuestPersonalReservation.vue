<template>
  <v-container grid-list-md>
    <v-layout wrap>
      ...
      <v-flex xs12 md6>
        <v-flex xs12 sm12 md12 v-for="room1 in rooms" :key="room1.roomtpe_id">
          <v-card>
            <v-card-text>
              <v-container grid-list-md>
                <v-layout wrap>
            ...
            <v-card-actions md6>
              <v-btn flat color="accent" @click.native="addRoomType(room1)">
                Pesan
              </v-btn>
              <v-spacer></v-spacer>
      ...
      <v-flex xs12 sm12 md6 v-if="this.items.roomTypes.length!=0" weight>
        <v-card height="100%">
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="accent" @click.stop="dialog = true">Isi Data Diri</v-btn>
          </v-card-actions>
          ...
          <v-card-text>
            ...
            <div v-if="items.name!==''">
              ...
              <v-card-actions>
                <v-btn block color="info" @click.stop="dialog3=true">Reservasi</v-btn>
              </v-card-actions>
            </div>
          </v-card-text>
        </v-card>
